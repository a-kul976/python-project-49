...
[![hexlet-check](https://github.com/a-kul976/python-project-49/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/a-kul976/python-project-49/actions)
...
```bash
git clone https://github.com/a-kul976/python-project-49.git
